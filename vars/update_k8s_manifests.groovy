...
def call(Map config = [:]) {
    ...
    withCredentials([usernamePassword(
        ...
        sh """
            # Update main application deployment - note the correct image name is arnab23/easyshop-app
            ...
            if git diff --quiet; then
                ...
                git remote set-url origin https://\${GIT_USERNAME}:\${GIT_PASSWORD}@github.com/Arnab2239/tws-e-commerce-app.git
